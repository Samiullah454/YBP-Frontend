...
export const API_BASE_URL = environment.apiLiveUrl;
...
export class AccountServiceProxy {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        ...
        this.baseUrl=environment.hubUrl;
    }
...
export class SubscriptionServiceProxy{
    ...
    create(createSubscriptiondto:SubscriptionDto) 
    {
        
        return this.http
        .post<any>(`${environment.apiLiveUrl}/services/app/TenantPackageSubscription/Create`,createSubscriptiondto)
        .pipe(
            map(response => {          
            return response;  
            })
...
export class TransactionServiceProxy{
    ...
    {
        return this.http
        .post<any>(`${environment.apiLiveUrl}/services/app/Transaction/Create`,transactionDto)
        .pipe(
            map(response => {
                return response;  
            })
...
export class TenantServiceProxy {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl =environment.apiLiveUrl;
    }

    create(createTenanatobj:any) 
    {
        
        return this.http
        .post<any>(`${environment.apiLiveUrl}/services/app/Tenant/Create`,createTenanatobj)
        .pipe(
            map(response => {          
            return response;  
            })
    ...
    //     let url_ = this.baseUrl + "/services/app/Tenant/Create";
    //     url_ = url_.replace(/[?&]$/, "");
...
export class UserServiceProxy {
    private http: HttpClient;
    private baseUrl: string=environment.apiLiveUrl;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    create(body: CreateUserDto | undefined): Observable<UserDto> {
        ...
        let url_ = environment.apiLiveUrl + "/services/app/User/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getRoles(): Observable<RoleDtoListResultDto> {
        ...
        let url_ = environment.apiLiveUrl + "/services/app/User/GetRoles";
        url_ = url_.replace(/[?&]$/, "");
...
export class SubscriptionDto implements ISubscriptionDto {
    ...
    broadcasts: number;
    packagePrice: number;
    addTeamMemberPrice: number;
    addNumberPrice: number;
    addCreditPrice: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.startDate = new Date(_data["startDate"]);
            this.endDate = new Date(_data["endDate"]);
            this.status = _data["status"];
            this.paymentStatus = _data["paymentStatus"];
            this.lastPaymentDate = new Date(_data["lastPaymentDate"]);
            this.nextPaymentDate = new Date(_data["nextPaymentDate"]);
            this.paymentgatewayTransactionId = _data["paymentgatewayTransactionId"];
            this.autoRenew = _data["autoRenew"];
            this.creationTime = new Date(_data["creationTime"]);
            this.packageName = _data["packageName"];
            this.teamMembers = _data["teamMembers"];
            this.sMSCredits = _data["sMSCredits"];
            this.sMSSender = _data["sMSSender"];
            this.minTeamMembers = _data["minTeamMembers"];
            this.contacts = _data["contacts"];
            this.templates = _data["templates"];
            this.broadcasts = _data["broadcasts"];
            this.packagePrice = _data["packagePrice"];
            this.addTeamMemberPrice = _data["addTeamMemberPrice"];
            this.addNumberPrice = _data["addNumberPrice"];
            this.addCreditPrice = _data["addCreditPrice"];            
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["sMSCredits"] = this.sMSCredits;
        data["sMSSender"] = this.sMSSender;
        data["minTeamMembers"] = this.minTeamMembers;
        data["contacts"] = this.contacts;
        data["templates"] = this.templates;
        data["broadcasts"] = this.broadcasts;
        data["packagePrice"] = this.packagePrice;
        data["addTeamMemberPrice"] = this.addTeamMemberPrice;
        data["addNumberPrice"] = this.addNumberPrice;
        data["addCreditPrice"] = this.addCreditPrice;
...
export class CustomerProfileDto implements ICustomerProfileDto {
    cardNumber: string;
    cvv: string;
    expiry: string;
    email: string;
    ...
    constructor(data?: ICustomerProfileDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.b_firstName = _data["b_firstName"];
            this.b_lastName = _data["b_lastName"];
            this.b_address = _data["b_address"];
            this.b_state = _data["b_state"];
            this.b_city = _data["b_city"];
            this.b_zipCode = _data["b_zipCode"];            
        }
    }

    static fromJS(data: any): CustomerProfileDto {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerProfileDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["b_firstName"] = this.b_firstName;
        data["b_lastName"] = this.b_lastName;
        data["b_address"] = this.b_address;
        data["b_state"] = this.b_state;
        data["b_city"] = this.b_city;
        data["b_zipCode"] = this.b_zipCode;
        return data; 
    }

    clone(): CustomerProfileDto {
        const json = this.toJSON();
        let result = new CustomerProfileDto();
        result.init(json);
        return result;
...
export class ChargeCustomerProfileDto implements IChargeCustomerProfileDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.customerProfileId = _data["customerProfileId"];
            this.paymentProfileId = _data["paymentProfileId"];
...
export interface IChargeCustomerProfileDto {
    customerProfileId: string;
    paymentProfileId: string;
    amount: number;
    invoiceNumber: string;
...
export class TransactionDto implements ITransactionDto {
    ...
    authCode:string;
    paidAmount:number;
    addSentSMSCount?: number | null;
    addSentSMSPrice?: number | null;
    addReceiveSMSCount?: number | null;
    addReceiveSMSPrice?: number | null;
    addUserCount?: number | null;
    addUserPrice?: number | null;
    addNumberCount?: number | null;
    addNumberPrice?: number | null;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.addSentSMSCount = _data["addSentSMSCount"];
            this.addSentSMSPrice = _data["addSentSMSPrice"];
            this.addReceiveSMSCount = _data["addReceiveSMSCount"];
            this.addReceiveSMSPrice = _data["addReceiveSMSPrice"];
            this.addUserCount = _data["addUserCount"];
            this.addUserPrice = _data["addUserPrice"];
            this.addNumberCount = _data["addNumberCount"];
            this.addNumberPrice = _data["addNumberPrice"];
            this.previousPackageId = _data["previousPackageId"];
            this.currentPackageId = _data["currentPackageId"];  
    ...
    toJSON(data?: any) {
        ...
        data["addSentSMSCount"] = this.addSentSMSCount;
        data["addSentSMSPrice"] = this.addSentSMSPrice;
        data["addReceiveSMSCount"] = this.addReceiveSMSCount;
        data["addReceiveSMSPrice"] = this.addReceiveSMSPrice;
        data["addUserCount"] = this.addUserCount;
        data["addUserPrice"] = this.addUserPrice;
        data["addNumberCount"] = this.addNumberCount;
        data["addNumberPrice"] = this.addNumberPrice;
        data["previousPackageId"] = this.previousPackageId;
        data["currentPackageId"] = this.currentPackageId;
